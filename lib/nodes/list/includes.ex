defmodule Rubik.Nodes.List.Includes do
  @moduledoc """
  Documentation for `Rubik.Nodes.List.Includes`.
  """
  ...
  defimpl Rubik.Node.Executable do
    ...
    def execute(node, args) do
      ...
      result = Enum.any?(list, fn item -> Map.get(item, String.to_atom(key)) == value end)
