defmodule Rubik.Nodes.Arithmetic.Multiply do
  @moduledoc """
  Documentation for `Rubik.Nodes.Arithmetic.Multiply`.
  """
  ...
  defimpl Rubik.Node.Executable do
    ...
    def execute(node, args) do
      x1 = Keyword.fetch!(args, :x1) |> Common.Decimal.ensure_decimal()
      x2 = Keyword.fetch!(args, :x2) |> Common.Decimal.ensure_decimal()
